...
Promise.all([d3.csv("unbonded.csv"), d3.csv("bonded.csv")]).then(function (data) {
...
// Read the data
// Scatter plot
d3.csv("cosmos.csv").then(function (data) {
  ...
  svg2
    ...
    .call(d3.axisBottom(x2).tickFormat(d3.timeFormat("%m/%d %H:%M")))
    .select(".domain")
    .remove();
